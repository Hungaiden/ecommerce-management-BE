export const swaggerDocument = {
  ...
  info: {
    title: "TrendVibe API",
    version: "1.0.0",
    description: "API documentation for TrendVibe e-commerce backend",
  },
  servers: [
  ...
  components: {
    ...
    schemas: {
      LoginBody: {
        ...
        properties: {
          email: { type: "string", example: "admin@trendvibe.vn" },
      ...
      ProductCreate: {
        ...
        properties: {
          ...
          brand: { type: "string", example: "TrendVibe" },
      ...
      SystemSetting: {
        type: "object",
        properties: {
          websiteName: { type: "string", example: "TrendVibe" },
          logo: { type: "string", example: "https://..." },
          phone: { type: "string", example: "0912345678" },
          email: { type: "string", example: "contact@trendvibe.vn" },
    ...
    "/auth/login": {
      post: {
        ...
        responses: {
          200: {
            description:
              "Đăng nhập thành công, trả về accessToken & refreshToken",
          },
